...
class GRU_LORA:
    ...
    def __init__(self, 
        ...
        print('Dense GRU params: ', (4*hidden_size*(input_size+hidden_size) + hidden_size*output_size))
    ...
    def reshape_params(self, params):
        Wr_shape = (self.input_size, self.hidden_size)
        Wu_shape = (self.input_size, self.hidden_size)
        Wh_shape = (self.input_size, self.hidden_size)
    ...
    '''def forward_evel(self, params, x):
        ...
        h  = self.gru(params[:self.Rz.end,], x, h)

...
def main(args):
    ...
    model_configs = {
        'LoRA-RTRL_6': {'type': 'lora_rtrl', 'level': 2, 'online': False, 'recurrent_density': 1, 'inout_density': 1, 'rank_constraint_w': 6, 'rank_constraint_r': 6},
        'LoRA-RTRL_8': {'type': 'lora_rtrl', 'level': 2, 'online': False, 'recurrent_density': 1, 'inout_density': 1, 'rank_constraint_w': 8, 'rank_constraint_r': 8},
        'LoRA-RTRL_10': {'type': 'lora_rtrl', 'level': 2, 'online': False, 'recurrent_density': 1, 'inout_density': 1, 'rank_constraint_w': 10, 'rank_constraint_r': 10},
        'LoRA-RTRL_15': {'type': 'lora_rtrl', 'level': 2, 'online': False, 'recurrent_density': 1, 'inout_density': 1, 'rank_constraint_w': 15, 'rank_constraint_r': 15}
    }
    ...
    plt.grid(True)
    plt.savefig(f'wiki_loss_gru_32_lora_rank.png', bbox_inches='tight')
